...
print('''
-------------------------------------------------''')
print("When a file doesn't exist then a FileNotFoundError exception is raised")
yfile = open('text-file-matrix2.txt')
print(yfile)
zfile = open('text-file-very-short.txt')
print(zfile)
