#Ch2 - Flow Control - IF/ELIF - Guess-1-Lab
...
def main():
  ...
  #  1) Add some comments to describe your code guess-01-Aavni-Jon.py
  # -------------------------------------------
  ...
  are initialized. Then a conditional checks if the user guess is equivalent to the number than 
  needs to be guessed. If it's not the same, then an appropriate message is printed. If it is, 
